...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 23 Mars 2017 à 09:00
...
CREATE TABLE `place` (
  ...
  `photo_path2` varchar(500) NOT NULL,
  `photo_path3` varchar(500) NOT NULL,
  `photo_bath4` varchar(500) NOT NULL,
...
INSERT INTO `place` (`id`, `name`, `description`, `photo_path`, `photo_path2`, `photo_path3`, `photo_bath4`, `latitude`, `longitude`) VALUES
